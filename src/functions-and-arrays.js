...
const negativeValuesArray = [-2, -5, -8];
const numbersArray = [2, 6, 9, 10, 7, 4, 1, 9];

console.log(averageNumbers(emptyArray));
console.log(averageNumbers(oneElementArray));
console.log(negativos(negativeValuesArray));
console.log(averageNumbers(numbersArray));
...
function averageWordLength(wordsArr) {
    ...
    for (let i = 0; i < wordsArr.length; i++) {
        allLength += wordsArr[i].length;
    }
    const avarege = allLength / wordsArr.length;
    return avarege;
}
...
function uniquifyArray(wordsUnique) {
    ...
    for (let i = 0; i < wordsUnique.length; i++) {
        ...
        if (uniqueWordsArray.indexOf(currentWord) === -1) {
            uniqueWordsArray.push(currentWord);
        }
    }
...
function howManyTimes(wordsCount, targetWord) {
    if (wordsCount.length === 0) {
        return 0;
    }
    let count = 0;
    for (let i = 0; i < wordsCount.length; i++) {
        if (wordsCount[i] === targetWord) {
            count++;
        }
    }
    return count;
...
console.log(howManyTimes([], 'world'));
console.log(howManyTimes(['bye'], 'bye'));
// Iteration #8: Bonus
const matrix = [
