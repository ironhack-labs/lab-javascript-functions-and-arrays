...
function greatestProduct(matrix) {
  ...
  const arrayValor = [0,0,0,0]
  const arrayPosY = [0,0,0,0]
  const arrayPosX = [0,0,0,0]
  let product = 1
  

  for(let z=0; z<=arrayValor.length-1;z++){
    for(let i=0; i<=matrix.length-1;i++){
      for(let j=0; j<=matrix[i].length-1;j++){
        if(matrix[i][j]>arrayValor[z]){
          arrayValor[z]=matriz[i][j]
          arrayPosY[z]=i
          arrayPosX[z]=j
        }
      }
...
function greatestProductDiagonal(matrix){
  ...
  for(let z=0; z<=arrayValor.length-1;z++){
    for(let i=0; i<=matrix.length-1;i++){
      for(let i=0; i<=matrix[i].length-1;j++){
        if(matrix[i][i]>arrayValor[z]){
          arrayValor[z]=matriz[i][j]
          arrayPosY[z]=i
          arrayPosX[z]=i
        }
