...
function sum(arrayOfValues){
  ...
  for (let i = 0; i <= arrayOfValues.length-1; i++) {
    const currentElement = arrayOfValues[i];
    if (typeof currentElement === 'string'){
      finalCount += currentElement.length;
  } else if (typeof currentElement === 'object' || typeof currentElement === 'array'){
    throw new Error("Unsupported data type sir or ma'am")
  } else {
    finalCount += currentElement;
  }
} return finalCount
}
...
//     if (typeof currentElement === 'string'){
//       finalCount += currentElement.length {
//       } elseif (currentElement === true) {
//         finalCount +=1
//       } elseif (currentElement === false){
//         finalCount +=0;
//       } else {
//         finalCount += currentElement;
//       }
//     }
//   } return finalCount/arr.length
// }
