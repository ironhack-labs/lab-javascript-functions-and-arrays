...
function averageWordLength(wordsArr) {
  ...
  averageLength = averageLength / wordsArr.length;
...
function avg(mixedArr2) {
  ...
  for (let i = 0; i < mixedArr2.length; i++) {
    if (typeof mixedArr2[i] === "number") {
      averageArray += mixedArr2[i];
    } else if (typeof mixedArr2[i] === "string") {
      averageArray += mixedArr2[i].length;
    } else if (mixedArr2[i] == true) {
      averageArray += 1;
    } else if (mixedArr2[i] == false) {
      averageArray += 0;
    }
  }
  averageArray = averageArray / mixedArr2.length;
  return averageArray;
}
...
function doesWordExist(wordsFind, searchingFor) {
  if (wordsFind.length === 0) {
    return null;
  }

  for (let i = 0; i < wordsFind.length; i++) {
    if (wordsFind.includes(searchingFor)) {
      return true;
    } else {
      return false;
    }
...
function howManyTimes(wordsCount, searchingFor) {
