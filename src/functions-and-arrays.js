...
function sum(mixArray) {
  ...
  for (let i = 0; i < mixArray.length; i++) {
    ...
    } else if (typeof mixArray[i] === "boolean" && mixArray[i] === true) {
      total++
    } else if (typeof mixArray[i] === "object") {
