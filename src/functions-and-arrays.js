...
(result);
/*El último de los test lo plantee así: 
...
function averageWordLength(wordsArr) {
  ...
  let sumArr = sum(wordsArr);
  return (sumArr / wordsArr.length);
}
//Bonus
...
function avg(numbersArray) {
  ...
  let sumNum = sum(numbersArray);
  return (sumNum / numbersArray.length);
}

/*No consigo que me sirva  el let SumNum*/
...
function uniquifyArray(duplicate, word) {
  ...
  function greatestProduct(datos) {
    let one = 1;
