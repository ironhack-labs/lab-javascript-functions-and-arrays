...
// Versão Antiga
// function sumNumbers(banana) {

//   let result = 0;
//   for (let i = 0; i < banana.length; i++) {
//       result = result + banana[i];
//   }
//   return result; 
...
//     return null;
//   } else {
//    let soma = sumNumbers(numbersAvg);
...
//   }
//   let result = averageNumbers(wordsLength);
//   return result;
// }
...
const uniquifyArray = (arr) => {
  ...
  return arr.reduce((newArray, word) => {
