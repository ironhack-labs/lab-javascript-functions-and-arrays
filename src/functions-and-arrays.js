  ...
  for (let i = 0; i < matrix.length; i++) {
    for (let j = 0; j < matrix[i].length; j++) {
      if (j + 3 < matrix[i].length) {
        ...
        if (tempProduct > horizontalProduct) {
          horizontalProduct = tempProduct;
          horizontalNumbers = '';
          horizontalNumbers += matrix[i][j] + ',';
          horizontalNumbers += matrix[i][j + 1] + ',';
          horizontalNumbers += matrix[i][j + 2] + ',';
          horizontalNumbers += matrix[i][j + 3];
        }
      }
      if (i + 3 < matrix.length) {
        let tempProduct =
          matrix[i][j] * matrix[i + 1][j] * matrix[i + 2][j] * matrix[i + 3][j];
        if (tempProduct > verticalProduct) {
          verticalProduct = tempProduct;
          verticalNumbers = '';
          verticalNumbers += matrix[i][j] + ',';
          verticalNumbers += matrix[i + 1][j] + ',';
          verticalNumbers += matrix[i + 2][j] + ',';
          verticalNumbers += matrix[i + 3][j];
        }
      }
    }
  }
