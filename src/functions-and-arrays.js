...
function averageWordLength(wordAverage) {
  if (wordAverage.length === 0) return null;
  wordsLength = 0;
  for (let i=0; i<wordAverage.length; i++) {
    wordsLength += wordAverage[i].length;
  }
  return wordsLength/wordAverage.length;
}
