...
const words = ['mystery', 'brother', 'aviator', 'crocodile', 'pearl', 'orchard', 'crackpot', '123456789'];
...
function averageWordLength(arrayOfWords) {
  ...
  for (let i = 0; i < arrayOfWords.length; i++) {
    currentSum = currentSum + arrayOfWords[i].length;
  }
...
function uniquifyArray(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    const firstIndexOfWord = array.indexOf(currentWord);

    if (i === firstIndexOfWord) {
