...
console.log(doesWordExist(wordsFind, newWord));
...
function howManyTimes(arr, newWord) {
  let result = 0;
  
  arr.forEach(function(word, index) {
    
    if (arr[index].includes(newWord)) {
      result++;
    }
  }); return result; 
}

console.log(howManyTimes(wordsCount, newWord));
