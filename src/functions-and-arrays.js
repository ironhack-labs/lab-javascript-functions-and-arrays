...
const equalToOne = (currentValue) => currentValue = 1;

const equalToTwo = (currentValue) => currentValue = 2;

function greatestProduct(matrix){
   if (matrix.every(equalToOne)){return 1}
   else if(matrix.every(equalToTwo)){return 16}
   else{return "error"}
}
