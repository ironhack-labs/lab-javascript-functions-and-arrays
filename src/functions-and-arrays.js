...
function averageWordLength(arr42){
  ...
  var strLength = 0;
  var sum42 = 0;
  if(arr42.length === 0) return null;
  else if(arr42.length === 1) {
   str = arr42[0].split("");
   console.log(str)
    strLength = str.length;
    console.log(strLength)
      return strLength/arr42.length;
  } else if (arr42.length > 1) {
    for (i=0; i<arr42.length; i++){
    sum42 += arr42[i].length;
    }
    return sum42/arr42.length;
  }
...
function doesWordExist(arr6, word){
  if (arr6.length === 0) {
    return null;
  } else if (arr6.length ===1 && arr6[0] === word){
    return true;
...
function howManyTimes(arr7, word7) {
  ...
  if(arr7.length === 0) {
    ...
    for (let i = 1; i<arr7.length+1; i++) {
      console.log("----------")
      console.log(newArr7)
      if (newArr7[i-1] !== word7) {
        newArr7.push(arr7[i])
      } else if (newArr7[i-1] === word7) {
        newArr7.push(arr7[i])
        score++;
