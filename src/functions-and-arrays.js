...
//1. find length of every word in array
//2. return word with the highest length - can use Math.max
...
function averageWordLength(wordsArr) {
  if (wordsArr.length === 0) {
    ...
    return sumOfWords/wordsArr.length;
  }
}
...
function doesWordExist(word, someArray) {
  if (someArray.length === 0) {
    return null;
  }
