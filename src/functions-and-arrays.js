...
// Iteration #3.1 Bonus:
function sum() {}
const mixesArr = [6, 12, 'miammi', 1, true, 'barca', '200', 'Lisboa,' 8, 10];
//should return: 57

function sum(mixedArr.length === 0){
  return 0;
}
...
for (let i of wordsUnique) {
  if(uniquifyWords.indexOf(i) < 0) {
    uniquifyWords.push(i);
  }
