...
function findLongestWord(arrOfWords) {
    const longestWord = arrOfWords.sort(function(a, b) {
...
//function sum(arrayOfMixedValues) {
//let sumOfMixedValues = 0;
//for (let i = 0; i < arrayOfMixedValues.length; i++) {
//sumOfMixedValues += arrayOfMixedValues[i].length;
//}
//return sumOfMixedValues;
//}
