...
const moreNumbers = [2, 6, 9, 10, 7, 4, 1, 9];
...
const moreWords = ['seat', 'correspond', 'linen', 'motif', 'hole', 'smell', 'smart', 'chaos', 'fuel', 'palace'];
...
const newWords = ['machine', 'subset', 'trouble', 'starting', 'matter', 'eating', 'truth', 'disobedience'];
  
const doesWordExist = (array, searchWord) => {
    if (array.length === 0) return null;
