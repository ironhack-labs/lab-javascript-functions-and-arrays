...
function findLongestWord(arrayInput) {
    ...
    for (let i = 0; i < arrayInput.length; i++) {
      if (longestItem.length < arrayInput[i].length) {
        longestItem = arrayInput[i];
      }
    }
    return longestItem;
} 
