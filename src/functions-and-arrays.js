...
function findLongestWord(arrOfWords) {
  ...
  let longestWord = arrOfWords.sort(function(a, b){return b.length - a.length});
  return longestWord[0];
  } 
}

// Iteration #3: Calculate the sum
const numbers = [6, 12, 1, 18, 13, 16, 2,];
