...
function howManyTimes(arr, toCount) {
...
function greatestProduct(arr) {
  ...
  if(productSum === productCount) return 1
  if(productSum === (productCount * 2)) return 16
}
