...
function averageNumbers(numbersAvg) {
  ...
  if (numbersAvg.length === 0) return null;
    ...
    return numbersAvg / numbersAvg.length;
  }
...
function averageWordLength(wordsArr) {
  ...
  if (wordsArr.length === 0) {
    ...
    (joined = wordsArr.join("")), (result = joined.length / arrayLength);
    return result;
  }
}
...
function avg(arr) {
  ...
  if (count === 0) {
    return 0; // To handle an empty array or an array with no valid elements
  }
