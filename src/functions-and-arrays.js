...
averageNumbers = (arrNum) => {
  let total = 0;
  let div = arrNum.length;
...
averageWordLength = (arrWord) => {
  let wordSum = 0;
  let div = arrWord.length;
   for (let i = 0; i < arrWord.length; i++) {
     wordSum = wordSum + arrWord[i].length;
   };
   wordSum = wordSum / div;
   return wordSum;
 };
