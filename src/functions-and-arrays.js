...
function averageWordLength(wordsArr){
  ...
  return null;
    ...
    arrAvg += wordsArr[i].length
  }
  arrAvg = arrAvg / wordsArr.length;
}
 return arrAvg;
}
...
function doesWordExist(wordSearch, words){
  if (wordSearch.length === 0){
    return null;

  } if 
  (wordSearch.includes(words)){
    return true;
