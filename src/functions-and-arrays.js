...
console.log(findLongestWord(words));   // É ISTO QUE QUERO
...
function doesWordExist(anotherArray, anotherWord) {
let doesExist = false;

if (!anotherArray.length) return null;
for(let i=0; i<anotherArray.length; i++){
     if(anotherArray[i] === anotherWord){
 doesExist = true;
 }
}
return doesExist;
