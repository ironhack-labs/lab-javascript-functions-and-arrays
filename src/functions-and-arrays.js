...
// ------------------- BONUS: Iteration #3: Calculate the sum
function sum(numbers) {
  ...
  for (let i = 0; i < numbers.length; i++) {
    switch (typeof numbers[i]) {
      case "boolean":
        variableSum += numbers[i];
        break;
      case "string":
        variableSum += numbers[i].length;
        break;
      case "number":
        variableSum += numbers[i];
        break;
...
function averageNumbers(numbers) {
  ...
  avgVar = sumNumbers(numbers) / numbers.length;
...
// ------------------- BONUS: Iteration #4.1: Calculate the average
...
function uniquifyArray(wordsUnique) {
  ...
  for (let i = 0; i < wordsUnique.length; i++) {
    if (wordsUnique.indexOf(wordsUnique[i]) >= i) {
      anotherArray.push(wordsUnique[i]);
    }
  }
