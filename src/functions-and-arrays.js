...
function sum(multiArray) {
  ...
  for (let i = 0; i < multiArray.length; i++) {
    if (multiArray[i] === true) {
      sum += 1;
    } else if (multiArray[i] === false) {
      sum += 0;
    } else if (typeof multiArray[i] === 'string') {
      sum += multiArray[i].length;
    } else if (typeof multiArray[i] === 'object') {
