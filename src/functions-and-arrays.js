...
// When I run an array with an object or array it returns error but also undefined
...
function avg(array) {
  ...
  let total = sum(array) / array.length;
...
function uniquifyArray(array) {
  ...
  let unique = [];
  for (let i = 0; i < array.length; i++) {
    // if unique doesn't contain we are at
    // put it in the unique array
