...
const words = ['mystery', 'brother', 'aviator', 'crocodile', 'pearl', 'orchard', 'crackpot'];
  ...
  const findLongestWord = (words) => {
    let word = "";
    if (words.length == 0) {return null} else{
...
let bis = [10, 5, 4, 32, 8]
console.log(sumNumbers([10, 5, 4, 32, 8]))
console.log('-------------------------------------')
// Iteration 3 : Bonus
const sum = (numbers) => {
  let sumNum = 0;
...
const averageNumbers = (numbersAvg) => {
  let sum = 0; if (numbersAvg == false) {return null} else {
...
const averageWordLength = (wordsArr) => {
  let sum = 0; if (wordsArr.length == 0) {return null} else {
