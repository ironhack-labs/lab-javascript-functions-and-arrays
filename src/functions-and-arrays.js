...
//Bonus 3.1
const  mixedArr  = [ 6 , 12 , ' miami ' , 1 , verdadero , ' barca ' , ' 200 ' , ' lisboa ' , 8 , 10 ];
...
function uniquifyArray(words) {
  ...
  const unique = words.filter((item, index) => {
...
function doesWordExist (words) {
  ...
  const found = words.includes(search);
  return found;
}
