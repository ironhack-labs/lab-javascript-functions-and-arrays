...
function findLongestWord(arrayParam) {
  ...
  for (let i = 0; i < arrayParam.length; i++) {
    if (longest.length < arrayParam[i].length) {
      longest = arrayParam[i];
    }
  }
  return longest;
}
...
function sumNumbers(arrayParam) {
  let counter = 0;
  for (let i = 0; i < arrayParam.length; i++) {
    counter += arrayParam[i];
  }
  return counter;
}
...
function averageNumbers(arrayParam) {
  if (arrayParam.length === 0) {
    return null;
  }
  ...
  let averageResult = counter / arrayParam.length;
...
function averageWordLength(arrayParam) {
  if (arrayParam.length === 0) {
    return null;
  }

  if (arrayParam.length === 1) {
    return arrayParam[0].length;
  }

  let counter = 0;
  for (let i = 0; i < arrayParam.length; i++) {
    counter += arrayParam[i].length;
  }
  let averageResult = counter / arrayParam.length;
  return averageResult;
}
...
function avg(arrayParam) {
  ...
  let result = 0;
  result = counter / arrayParam.length;
  return result;    
}
...
function doesWordExist(arrayParam, wordToSearch) {
  if (arrayParam.length === 0) {
    return null;
  }

  for (let i = 0; i < arrayParam.length; i++) {
    if (arrayParam.includes(wordToSearch)) {
      return true;
    } else {
      return false;
    }
...
function howManyTimes(arrayParam, wordToSearch) {
  let counter = 0;
  if (arrayParam.length === 0) {
    return 0;
  }
