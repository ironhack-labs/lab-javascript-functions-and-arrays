...
function averageNumbers(numbersAvg) {
 ...
 let numbersSum = 0;
 let indexSum = numbersAvg.length;

  if (indexSum === 0) {
    return null;
  }

  for (let n = 0; n < indexSum; n++) {
    numbersSum += numbersAvg[n];
  }

  numbersAvg = numbersSum / indexSum;
...
function uniquifyArray(wordsUnique) {
  ...
  let result = [];
  wordsUnique.forEach((item, index) => {
