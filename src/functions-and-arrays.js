...
function sum(mixedArr) {
  ...
  for (const i of mixedArr) {
    ...
    else if (typeof i === "boolean" || typeof i === "number") nyambers.push(i)
    else if (typeof i === "string") nyambers.push(i.length)
  }
  return sumNumbers(nyambers)
}
...
function uniquifyArray(wordsUnique) {
  // I just noticed that I just could use array.includes(elem) :/
  // instead of doing this weird thing
...
function doesWordExist(wordsFind, find) {
  return wordsFind.length === 0 ? null : wordsFind.includes(find)
}
