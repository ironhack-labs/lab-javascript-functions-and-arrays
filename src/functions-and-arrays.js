...
function findLongestWord (wordsArray) {
  ...
  return wordsArray[maxLengthIndex]
}
}
...
function sum (numbersArray) {
  let addedNums = 0;
    for (let i = 0; i < numbersArray.length; i++) {
      ...
      addedNums += 1;
    } else if (typeof numbersArray[i] == 'object' || typeof numbersArray[i] == 'array') {
...
function averageWordLength (arrayOfStrings) {
  ...
  for (let i = 0; i < arrayOfStrings.length; i++) {
    wordsToNumbers.push (arrayOfStrings[i].length)
  }
  return averageNumbers (wordsToNumbers)
}
...
function avg(arr) {
  ...
  return Math.round((sumNumbers(arr) / arr.length)*100)/100
}
}
...
function doesWordExist (arrayOfStrings, wordToSearch) {
  for (let i = 0; i < arrayOfStrings.length; i++) {
...
function howManyTimes (arrayOfStrings, wordToSearch) {
  let wordCounter = 0
  for (let i = 0; i < arrayOfStrings.length; i++) {
    if (arrayOfStrings[i] == wordToSearch) {
      wordCounter += 1
    }
  }
  return wordCounter
