...
function uniquifyArray(wordsUnique) {
  ...
  const uniqueSet = new Set(wordsUnique); //Set only allows unique values, removing duplicates
...
let wordSearching = 'matter';

function howManyTimes(wordsCount, wordSearching) {
