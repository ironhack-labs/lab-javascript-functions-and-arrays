...
const numbers = [6, 12, 1, 18, 13, 16, 2, 1, 8, 10, [1]];
...
function averageNumbers(element) {
  ...
  let result = element.reduce((a,b)=> a+b)
...
function avg(ele) {
  ...
  return finalResult = Number((count/ele.length).toFixed(2))
