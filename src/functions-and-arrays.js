...
function findLongestWord(words) {
  ...
  for (i = 1; i < words.length; i++) {
    ...
    } else if (words[i].length === palabraMasLarga.length) {
    }
  }
...
// Iteration #3.1 Bonus:
/*"NO SE HACERLO"const mixedArr = [6, 12, "miami", 1, true, "barca", "200", "lisboa", 8, 10];
...
function averageNumbers(numbersAvg) {
  ...
  const media = sum/numbersAvg.length
  return media
}
...
const media = sum/wordsArr.length
return media 
}
