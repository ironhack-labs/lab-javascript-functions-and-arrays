...
console.log(longestWord('mystery', 'brother', 'aviator', 'crocodile', 'pearl', 'orchard', 'crackpot'));
...
// Bonus #3
 ...
 function sum(mixed) {
   ...
   for (let element of array) {
     type = typeof element;
     if (type === 'object') throw new Error("Oops");
...
// Bonus #4 // Level 2: Array of strings 
