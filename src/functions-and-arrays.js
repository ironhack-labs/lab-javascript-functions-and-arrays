...
function doesWordExist(wordsFind,string) {
  if(wordsFind.length === 0) {
      return null
    }
  if(wordsFind.includes(string)){
    return true
  } else {
    return false
  }
...
function howManyTimes(wordsCount,string) {
