...
function avg(mixedArr) {
  ...
  return totalMix / mixedArr.length;
}
...
wordsUnique.array.forEach(element => {});
...
function howManyTimes(wordsCount, wordCompare) {

  let countRepetition = 0;

  for (i=0; i < wordsCount.length; i++){
      if (wordsCount[i] === wordCompare){
        countRepetition += 1;
