...
// Unique Arrays
var wordsUnique = ['iPhone', 'Samsung', 'Android', 'iOS', 'iPhone', 'Samsung', 'Nokia', 'Blackberry', 'Android'];

function uniquifyArray1(arr) {
  let uniqueArr = [];
  if (arr.length) {
...
// Finding Elements
var wordList = ['machine', 'subset', 'trouble', 'starting', 'matter', 'eating', 'truth', 'disobedience'];
