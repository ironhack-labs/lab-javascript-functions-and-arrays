  ...
  if (arrOfWords.length === 0) {
    ...
    for (let i = 0; i < arrOfWords.length; i++) {
      if (arrOfWords[i].length > counter) {
        ...
        longestWord.unshift(arrOfWords[i]);
      }
    }
...
function averageNumbers(arrOfNumbers) {
  if (arrOfNumbers.length === 0) {
    ...
    let average = sumArray(arrOfNumbers) / arrOfNumbers.length;
    return average;
  }
}
...
function averageWordLength(arrOfWords) {
  if (arrOfWords.length === 0) {
    ...
    for (let i = 0; i < arrOfWords.length; i++) {
      sumOfChar += arrOfWords[i].length;
    }

    let average = sumOfChar / arrOfWords.length;
    return average;
  }
}
...
function uniquifyArray(arrOfWords) {
  ...
  if (arrOfWords.length === 0) {
    ...
    for (let i = 0; i < arrOfWords.length; i++) {
      if (unique.indexOf(arrOfWords[i]) === -1) {
        unique.push(arrOfWords[i]);
      }
    }
...
function doesWordExist(arrOfWords, word) {
  ...
  for (let i = 0; i < arrOfWords.length; i++) {
    if (arrOfWords[i] === word) {
      controlArray.push(arrOfWords[i]);
    }
  }
...
function greatestProduct(arrOfNumbers) {
  let controlArray = [];
  for (let i = 0; i < arrOfNumbers.length; i++) {
    for (let j = 0; j < arrOfNumbers.length; j++) {
      if (controlArray.length <= 20) {
        controlArray.push(arrOfNumbers[i][j]);
      }
    }
  }
}
