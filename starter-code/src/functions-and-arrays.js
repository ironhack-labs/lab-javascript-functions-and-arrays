...
function averageNumbers(array)
{
  ...
  let average = (numberElements > 0) ? sum / numberElements : undefined
...
let numberOfWords = []
  ...
  {
    numberOfWords.push(word.length)
  })
return averageNumbers(numberOfWords)
}
...
return (array.length == 0) ? undefined : uniquifiedArray
}
