...
let largestNumber = maxOfTwoNumbers(3, 8);
...
let calculateAvg = averageNumbers(numbersAvg);
...
let avgWordLength = averageWordLength(wordsArr);
...
let newUniqueWords = uniquifyArray(wordsUnique);
...
let wordExistance = doesWordExist(wordsFind, "subs");
console.log(wordExistance);
...
let countWord = howManyTimes(wordsCount, "machine");
