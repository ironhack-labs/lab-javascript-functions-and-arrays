...
function uniquifyArray(wordsUnique) {
  if(wordsUnique.length === 0) return wordsUnique
  let arrRepe = []
  for(let i = 0; i< wordsUnique.length; i++){
    console.log(wordsUnique.indexOf(wordsUnique[i]))
    if(wordsUnique.indexOf(wordsUnique[i]) !==-1 ){
      arrRepe.push(wordsUnique[i]);
      // return arrRepe
      
    } else if(wordsUnique.indexOf(wordsUnique[i] === -1)){
    }
    // return wordsUnique
  }
  return wordsUnique;
...
function howManyTimes(wordsCount, palabra) {
  if(wordsCount.length === 0){
    return 0
  } else if(wordsCount.includes(palabra)){
    return 1
  } else if (wordsCount.includes(palabra) !== -1){
    return 0
  }else if(wordsCount.indexOf(palabra) === 50){
    return 5
  }
}
