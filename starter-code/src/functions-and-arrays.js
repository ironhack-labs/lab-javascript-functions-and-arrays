...
function findLongestWord(words){
  for (var w=words[0], i = 0; i < words.length; i++) {
...
//Receives an array of numbers and calculate the average of the numbers.
...
// Return true if it exists the word.
