...
// Finding Longest Word - need to come back to this! 
...
var searchFor = 'trouble';
var searchCount = 0;

function howManyTimes(wordsCount, searchFor) {
  for (var m = 0; m < wordsCount.length; m++) {
    if (wordsCount[m] === searchFor) {
      searchCount += 1;
    }
  }
  return searchCount;
