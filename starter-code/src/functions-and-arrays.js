...
function findLongestWord(array){
  for (var long = '', i = 0; i < array.length; i++) {
...
var suma = numbers.reduce((acc, curr)=>{
  return acc + curr;
}, 0);
console.log(suma);
...
var avg = numbersAvg.reduce((acc, curr)=>{
  return acc + curr;
},0);
...
function doesWordExist1(words, word){
...
function doesWordExist2(words, word){
  for (let i = 0; i < words.length; i++) {
...
console.log(doesWordExist4(wordsFind,'disobedience'));


function doesWordExist5(words, word){
  var found = wordsFind.find((element)=>{
    return element === word;
  });
  if (found) {
    return true;
...
console.log(doesWordExist5(wordsFind,'eating'));


function doesWordExist6(words, word){
  var found = wordsFind.some((element)=>{
    return element === word;
  });
  if (found) {
    return true;
...
console.log(doesWordExist6(wordsFind,'eating'));
