...
// Declare a function named findLongestWord that takes an argument an array of words and returns the longest one. If there are 2 with the same length, it should return the first occurrence.
const words = [
  "mystery",
  "brother",
  "aviator",
...
function averageWordLength(arr) {
  ...
  let avgLength = totalChar / arr.length;
  return avgLength;
}
...
// Take the following array, remove the duplicates, and return a new array. You're more than likely going to want to check out the indexOf Array method.
