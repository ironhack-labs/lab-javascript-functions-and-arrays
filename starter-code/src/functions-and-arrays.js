...
// Calculate the Average bzw. averageNumbers
...
function averageNumbers(arg) {
  ...
  return theAve / arg.length;
}

// Array of Strings bzw. averageWordLength
const wordsArr = [
  "seat",
  "correspond",
  "linen",
...
// Finding Elements — doesWordExist
const wordsFind = [
  "machine",
  "subset",
  "trouble",
...
function doewWordExist(words, search) {
  let exists = 0;
