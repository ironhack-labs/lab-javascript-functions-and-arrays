 ...
 * @param   matrix [20x20 grid]
 * @return         [object with solution]
 */
function greatestProduct(matrix) {
  ...
  var greatest = {
    ...
    i: 0, // vertical
    j: 0, //horizontal
    value: 0 // product of cross multiplication
  };

  for (var i = 0; i < matrix.length; i++) {
    for (var j = 0; j < matrix.length; j++) {

      currentValue = validations(matrix, i, j);
      if (greatest.value < currentValue) {
        greatest.value = currentValue;
        greatest.element = matrix[i][j];
        greatest.i=i;
        greatest.j=j;
      }
    }
...
/**
 * return the product of multiply cross elements
