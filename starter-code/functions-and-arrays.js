...
function findLongestWord (words) {
  ...
  var comparado = words[1];
  
for (i=0;i<=words.length;i++) { 
  console.log("Variable", comparado);
  if(comparado.length < words[i].length){    
    comparado = words[i];    
    }
  } 
  return comparado
