...
function sumArray (numbers) {
 sum = numbers.reduce(function(first,second){return first + second})
 return sum;
}
...
function uniquifyArray (words) {
 var uniqueArray = words.filter(function(elem, pos) {
