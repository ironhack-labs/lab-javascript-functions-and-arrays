...
wordLengthArray= [];
words.forEach(function(wordLength) {
  currentWordLength = wordLength.length
  wordLengthArray.push(currentWordLength);
});
var sortedWordLengthArray = wordLengthArray.sort();
return sortedWordLengthArray[wordLengthArray.length-1]
}
var words = [
  "mystery",
  "brother",
