...
function greatestProduct (matrix) {
        for(var i = 1; i < 19; i++) {
            for(var j = 0; j < 17; j++) {
                product = matrix[i][j] * matrix[i - 1 ][j + 1] * matrix[i + 1][j + 1] * matrix[i][j + 2];
                if(product > largest) {
                    largest = product;
                  }
    }
...
// greatest product of four adjacent numbers horizontal/vertical/diagonal
var product = 0;
var largest = 0;
...
var maxProduct2 = greatestProduct2(matrix);
