...
var longest = words.reduce(function(pre, curr) {
...
var totales = numbers.reduce(function(pre, curr) {
  return pre + curr;
});
...
averageNumbers = totales / numbers.length;
...
var uniq = words.reduce(function(pre, curr) {
