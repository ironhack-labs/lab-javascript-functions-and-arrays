//Declare a function maxOfTwoNumbers
...
words.forEach(function(e) {
  if (wordsUniq.indexOf(e) == -1) {
    wordsUniq.push(e);
  }
});

console.log(wordsUniq);
var uniquified = uniquifyArray(words);
...
function howManyTimes(list, wordRepeat) {
  var sum = 0;
  if (list.includes(wordRepeat)) {
