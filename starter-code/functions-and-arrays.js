...
var largest = maxOfTwoNumbers(9, 1);
...
var longest = findLongestWord(wordsArray);
console.log("The longest word of the array is: ",longest);
...
console.log("The average of the array is: " + averageLength);

// Unique Arrays
function uniquifyArray(array) {
  var newList = [];
  array.forEach(function(el){
    if (newList.includes(el) === false){
      newList.push(el)
    }
  })
  return newList;
...
var hasMatter = doesWordExist(words, "bus");
console.log("The word exists: ", hasMatter);

var hasDog = doesWordExist(words, "dog");
console.log("The word exists: ", hasDog);
