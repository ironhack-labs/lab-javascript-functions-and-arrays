...
describe("Bonus Quest:Product of adjacent numbers - greatestProduct", () => {
...
describe("Bonus Quest:Product of diagonals - greatestProductOfDiagonals", () => {
  it("should create a function named greatestProductOfDiagonals", () => {
  ...
  it("should return 40 when the diagonal numbers are [2, 5, 2, 2]", () => {
    let matrix = [
      [2, 2, 2, 2],
      [2, 5, 2, 2],
      [2, 2, 2, 2],
    ...
    expect(greatestProductOfDiagonals(matrix)).toBe(40);
  });
});
