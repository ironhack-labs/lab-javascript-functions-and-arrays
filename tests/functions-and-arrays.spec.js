...
describe("Bonus Quest - greatestProduct", () => {
  ...
  it("should return 51267216 when the matrix is as in lab-description", () => {
    let matrix = [
...
describe("Extra-Bonus Quest - Product of diagonals", () => {
  it("should declare a function named greatestProductOfDiagonals", () => {
    expect(typeof greatestProductOfDiagonals).toBe("function");
  });

  it("should return 70600674 for diagonals when the matrix is as in lab-description", () => {
    let matrix = [
      [8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8],
      [49, 49, 99, 40, 17, 81, 18, 57, 60, 87, 17, 40, 98, 43, 69, 48, 4, 56, 62, 0],
      [81, 49, 31, 73, 55, 79, 14, 29, 93, 71, 40, 67, 53, 88, 30, 3, 49, 13, 36, 65],
